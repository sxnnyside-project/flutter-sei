...
If you find a security vulnerability in **flutter_sei**, report it privately before disclosing it publicly.

**Preferred channel:**
Email — `legal.sxnnyside@sxnnysideproject.com`

**Alternative:**
[GitHub Private Security Advisory](https://github.com/sxnnyside-project/flutter-sei/security/advisories/new)
...
This policy covers the **flutter_sei** repository only.
